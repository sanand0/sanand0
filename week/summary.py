...
def describe_cli() -> Dict[str, Any]:
    ...
    return {
        "name": "summary.py",
        "description": "Generate weekly GitHub summaries, podcast scripts, and segmented Gemini TTS audio.",
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        description=(
            ...
            "audio from a speaker-labeled script using line-by-line Gemini TTS."
        )
    )
    parser.add_argument(
        "command",
        ...
        help="`weekly` fetches GitHub activity; `tts-script` renders a script line by line",
    )
